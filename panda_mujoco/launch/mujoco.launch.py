...
def generate_launch_description():
    ...
    xacro2mjcf = Node(
        ...
        parameters=[{'robot_descriptions': [robot_description_string]}, # robot descriptions of ros robots (it is possible to load multiple robot descriptions, but ros use only one at time
                    ...
                    {'mujoco_files_path': mujoco_model_path}]   # Path to the output folder (the output file must be in this folder)
    )
    ...
    mujoco = Node(
        ...
        parameters=[
            ...
            {"clock_publisher_frequency": 0.0}]         # If 0 the clock is published with sumulation frequency, otherwise it is in Hz
    )
