#!/bin/env python3
"""Launch smoke test for the unitree_h1 example (no viewer; GL sensors off with DISABLE_OPENGL=1).
...
class TestUnitreeH1Example(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        rclpy.init()
        cls.node = rclpy.node.Node("test_unitree_h1_example_node")
    ...
    def test_node_comes_up(self):
        ...
        self.fail(
            ...
            "MuJoCo failed to load the unitree_h1 example model"
        )
